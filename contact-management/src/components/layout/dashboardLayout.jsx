        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen flex flex-col">
            <header className="bg-gradient shadow-lg">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <Link to="/dashboard/user" className="flex items-center hover:opacity-90 transition-opacity duration-200">
                    ...
                    <nav>
                        <ul className="flex space-x-6">
                            <li>
                                <Link to="/dashboard/user/profile" className="text-gray-100 hover:text-white flex items-center transition-colors duration-200">
                                    <i className="fas fa-user-circle mr-2" />
                                    <span>{name ? name : 'profile'}</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/dashboard/user/logout" className="text-gray-100 hover:text-white flex items-center transition-colors duration-200">
