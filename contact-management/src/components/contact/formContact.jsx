        ...
        <div className="container mx-auto px-4 py-8 flex-grow">
            ...
            <div className="flex justify-center mb-4">
                <h1 className="text-2xl font-bold text-white flex items-center justify-items-center">
                    <i className="fas fa-user-plus text-white-400 mr-3" /> {title}
                </h1>
            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" id="first_name" name="first_name"
                                        ...
                                        placeholder="Enter first name" required value={first_name} onChange={onFirstNameChange} />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" id="last_name" name="last_name"
                                        className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                        placeholder="Enter last name" required value={last_name} onChange={onLastNameChange} />
                                </div>
                            </div>
                        </div>
                        <div className="mb-5">
                            ...
                            <div className="relative">
                                ...
                                <input type="email" id="email" name="email" className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                    placeholder="Enter email address" required value={email} onChange={onEmailChange} />
                            </div>
                        </div>
                        <div className="mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input type="tel" id="phone" name="phone" className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                    placeholder="Enter phone number" required value={phone} onChange={onPhoneChange} />
                            </div>
                        </div>
