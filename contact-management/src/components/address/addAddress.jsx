...
export default function AddAddress() {
    ...
    async function handleSubmit(e){
        ...
        const response = await addressAdd(token, id, {street, city, province, country, postal_code})
        const responseBody = await response.json()
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end space-x-4">
                            <Link to={`/dashboard/contact/${id}`} className="px-5 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 flex items-center shadow-md">
